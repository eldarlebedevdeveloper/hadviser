jQuery(function ($) {
    ...
    if(initialSlideNumber !== 1) {
		...
		$(".theiaPostSlider_slides").css("margin-top", "40px");
    ...
    $(document).bind("theiaPostSlider.changeSlide", function (
	   ...
	   setTimeout(function () {
        if (nextHeight - firstHeight > 100) {
			...
			$(".theiaPostSlider_slides").after('<div class="extra-content" style="height: 80px"></div>');
